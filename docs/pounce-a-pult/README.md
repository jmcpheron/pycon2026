...
canonical homes for the design live alongside this repo:
...
The files under [`step-demo/`](../../step-demo/) are just the
exported STEP plus everything [`cardlab`](../../src/cardlab/)
derives from it.
...
| ![Square mounting reference](assets/parts/Part_1_5.png) | `Part_1_5` | 86 × 1.5 × 86 | The thin square reference plate visible in the Onshape doc. |
...
The pounce-a-pult is another of my designs, published under
[Creative Commons Attribution 4.0 (CC BY)](https://creativecommons.org/licenses/by/4.0/)
— a more permissive choice than the rest of this repo's 3D files, so
anyone can remix and redistribute the toy without share-alike strings
attached.
...
- The **printable bundle** is on [MakerWorld](https://makerworld.com/en/models/2138778-pounce-a-pult-spiral-cat-toy#profileId-2316710) — slicer profile, photos, assembly tips, and a place to leave a like.

The `step-demo/pounce-a-pult.step` file is the STEP export from that
Onshape document; every render in this folder
(`docs/pounce-a-pult/assets/*.{png,gif,glb}` and `parts/*`) is a
derivative work of it and inherits **CC BY 4.0** — distinct from the
rest of this repo's [`LICENSE-3D-FILES`](../../LICENSE-3D-FILES) (CC
BY-SA 4.0).

If you remix the toy, please carry the attribution forward.

---

*Generated by `cardlab` from `step-demo/pounce-a-pult.step` — same
Python pipeline as the gear card, run against a different design.*
